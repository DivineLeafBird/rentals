        ...
        <div class="results-container">
            ...
            <div class="result-card">
                <img src="images/slider.png" alt="">
                    ...
                    <div>
                        <span style="font-size: 16px;color:rgba(92, 86, 86, 0.815);"><i class="bi bi-geo-alt icons"></i> mavueni,kilifi</span>
                    </div>
                    <div>
                    ...
                    <div>
                        <span style="font-size: 16px;color:#2c64f5;"> Bed-sitter</span>
                    </div>
