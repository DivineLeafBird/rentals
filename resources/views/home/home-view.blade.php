            ...
            <div class="amenties-container-button">
                ...
                <div class="buttons-container">
                    <button class="blue-btn"><a href="{{ route('homeDetails', $home = $randomHome->id) }}">Virtual
                            tour</a></button>
                    <button class="blue-btn"><a href="{{ route('schedule_home', ['schedule' => $randomHome->id]) }}">
                            Schedule tour</a></button>
                    <button class="blue-btn"><a href="{{ route('contact') }}"><i class="bi bi-telephone-fill tele"></i>
                            Call
                            Agency</a></button>
                    <button class="blue-btn"><a href="{{ route('application_form', ['form' => $randomHome->id]) }}">
                            Rent</a></button>
