        ...
        <nav> 
            ...
            <div id="mySidenav" class="sidenav">
                <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                    <form action="#"style="margin-top: 40px;" > <input type="text" placeholder="Search..."><button style="background-color:transparent; border: none; "  type="submit"><i  class="bi bi-search sidenav-icon" ></i></button> </form>
                ...
                @auth
                    ...
                    <a href=""><span><i class="bi bi-chat-square-text-fill profile-icons"></i> Messages</span></a>
                ...
                @if (Route::has('login'))
                    ...
                    <hr>
                    <a href="{{ url('/logout') }}"><span><i class="bi bi-box-arrow-in-right profile-icons"></i> Logout</span></a>
                ...
                @if (Route::has('login'))
                    ...
                    @auth
                        ...
                        <div class="notification">
                            <span onclick="notifications()" href="" class="btn icons"> <i class="bi bi-bell-fill"></i></span>
                        ...
                        <div class="profile">
                            ...
                            <div id="profileDropdown" class="dropdown-content">
                                    ...
                                    <div class="profile-left">
                                        ...
                                        <div class="socials">
                                            <h5>Connect With Us</h5>
                                                ...
                                                <a href=""><span><i class="bi bi-pie-chart-fill profile-icons"></i> Blog</span></a>
                                                <a href=""><span><i class="bi bi-facebook profile-icons"></i> Facebook</span></a>
                                                <a href=""><span><i class="bi bi-instagram profile-icons"></i> Instagram</span></a>
                                                <a href=""> <span><i class="bi bi-twitter profile-icons"></i> Twitter</span></a>
                                ...
                                <div class="profile-logout">
                                        <a href="{{ url('/logout') }}"><i class="bi bi-box-arrow-in-right" style="color:#2c64f5; padding-right: 8px;"></i> Logout</a>
                                </div>
