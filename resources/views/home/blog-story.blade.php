    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="post-pagination clearfix border-top border-bottom py-4">
                    <div class="prev-post">
                        <a href="blog-single.html">
                            <span class="text-uppercase font-sm letter-spacing">Next</span>
                            <h5 class="mt-3"> Intel’s new smart glasses actually look good</h5>
                        </a>
                    </div>
                    <div class="next-post">
                        <a href="blog-single.html">
                            <span class="text-uppercase font-sm letter-spacing">Previous</span>
                            <h5 class="mt-3">Free Two-Hour Delivery From Whole Foods</h5>
                        </a>
                    </div>
                </div>
                ...
                <div class="comment-area my-5">
                    <h4 class="mb-4 text-center">2 Comments</h4>
                        ...
                        <div class="sidebar-widget mb-5 ">
                            ...
                            <div class="sidebar-post-item-big">
                                ...
                                <div class="mt-3 media-body">
                                    <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                        2019</span>
                                    <h5><a href="blog-single.html">Meeting With Clarissa, Founder Of Purple
                                            Conversation App</a></h5>
                                </div>
                            </div>
                            ...
                            <div class="media border-bottom py-3 sidebar-post-item">
                                ...
                                <div class="media-body">
                                    <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                        2019</span>
                                    <h5><a href="blog-single.html">Thoughtful living in los Angeles</a></h5>
                                </div>
                            </div>
                            ...
                            <div class="media py-3 sidebar-post-item">
                                ...
                                <div class="media-body">
                                    <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                        2019</span>
                                    <h5><a href="blog-single.html">Vivamus molestie gravida turpis.</a></h5>
                                </div>
                            </div>
                        </div>
